...
# For each value of variable Condition, identify matching rows in stimuli.log; for these rows, pass the first vector of stimuli.log to a file named by Condition value with .1d suffix.
...
# Report in terminal the number of lines in each file of subdirectory; confirm files were created.
